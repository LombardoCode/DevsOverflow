		...
		<div id="app">
			<div id="contenido" class="text-sm relative overflow-hidden">
				...
				<div class="h-screen flex justify-center items-start bg-blue-600 md:bg-transparent">
					<div class="max-w-5xl flex-1 mt-6 rounded-md overflow-hidden">
						<div class="grid grid-cols-12">
							<div id="info" class="col-span-4 bg-blue-600 px-8 py-24 hidden md:block">
								<img src="/imagenes/comunidad.png" alt="Imagen de comunidad">
								<div id="razones" class="mt-10">
									<div class="razon mb-8">
										<div class="flex items-start">
											<div class="mr-2">
												<i class="fas fa-check-circle text-yellow-300 text-lg"></i>
											</div>
											<div>
												<span class="font-bold text-lg text-white">Comunidad</span>
												<p class="text-white">Únete a la comunidad más grande de programadores.</p>
											</div>
										</div>
									</div>
									<div class="razon mb-8">
										<div class="flex items-start">
											...
											<div>
												<span class="font-bold text-lg text-white">Explora y descubre</span>
												<p class="text-white">Accede a una gran variedad de preguntas. En DevsOverflow siempre obtendrás la respuesta indicada.</p>
											</div>
										</div>
									</div>
									<div class="razon">
										<div class="flex items-start">
											...
											<div>
												<span class="font-bold text-lg text-white">Gratuito</span>
												<p class="text-white">Crea hoy mismo tú cuenta y únete a la comunidad.</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div id="form-contenido" class="col-span-12 bg-white px-8 py-10 md:col-span-8">
								...
								<div class="flex justify-center">
									<div class="flex-1 max-w-xl">
										<h1 class="text-center font-bold text-xl mt-5 mb-3">Crear una cuenta</h1>
										@if ($errors->any())
										...
										<form action="/api/auth/register" method="POST">
											...
											<div class="flex flex-col mb-5">
												...
												<vue-input type="text" name="nombre" placeholder="Ingrese su nombre"></vue-input>
											</div>
											<div class="flex flex-col mb-5">
											...
											<div class="flex flex-col mb-5">
												<label for="nombre" class="mb-2 font-bold text-gray-700">Contraseña (de nuevo)</label>
												<vue-input type="password" name="password_denuevo" placeholder="Ingrese nuevamente su contraseña"></vue-input>
											</div>
											<div class="flex flex-col mb-3">
												<vue-input-submit type="submit" value="Crear una cuenta nueva"></vue-input-submit>
											</div>
										</form>
										<p class="text-center text-gray-600 mt-5">¿Ya tienes una cuenta? Inicia sesión haciendo clic <a href="/login" class="text-blue-800 underline">aquí</a>.</p>
